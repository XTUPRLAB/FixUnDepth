...
flags.DEFINE_float("depth_weight", 0.0, "Weight for depth_loss")
flags.DEFINE_float("match_weight", 0.0, "Weight for match_loss")
flags.DEFINE_float("epipolar_loss_weight", 0.0, "Weight for epipolar_loss")
flags.DEFINE_integer("total_epoch", 18, "The number  of  total_epoch")
