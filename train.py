...
flags = tf.app.flags
flags.DEFINE_string("dataset_dir", "/home/pu/data/", "Dataset directory")
flags.DEFINE_string("checkpoint_dir", "./checkpoints11/", "Directory name to save the checkpoints")
flags.DEFINE_string("init_checkpoint_file",  "./checkpoints11/model-120540", "Specific checkpoint file to initialize from")
flags.DEFINE_float("start_learning_rate", 0.0002, "Learning rate of for adam")
...
flags.DEFINE_float("depth_weight", 0.5, "Weight for depth_loss")
flags.DEFINE_float("match_weight", 1.0, "Weight for match_loss")
flags.DEFINE_float("epipolar_loss_weight", 0.5, "Weight for epipolar_loss")
flags.DEFINE_integer("total_epoch", 15, "The number  of  total_epoch")
