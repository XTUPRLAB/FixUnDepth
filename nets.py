...
def pose_exp_net(tgt_image, src_image_stack, do_exp=False, is_training=True, isReuse=None):
...
def disp_net(tgt_image, is_training=True, isReuse=None):
    batch_norm_params = {'is_training': is_training}
    with tf.variable_scope('depth_net', reuse=isReuse) as sc:
        end_points_collection = sc.original_name_scope + '_end_points'
        with slim.arg_scope([slim.conv2d, slim.conv2d_transpose],
